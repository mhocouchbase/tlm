...
solutions = [
  {
    "url": "https://github.com/couchbasedeps/v8-mirror.git@8.5.210.26",
    "managed": False,
    "name": "v8",
    "deps_file": "DEPS",
  },
...
#only enable v8_optimized_debug=false if it is not macosx as of V8 8.5 as it causes unitest failures
if [[ $PLATFORM != "macosx" ]]; then
